...
export function SettingsPage({ storageData, onRefresh }: SettingsPageProps) {
  ...
  const updateSetting = async (key: string, value: any) => {
    ...
    try {
      ...
      await storage.update({ settings: newSettings });
      await onRefresh();
  ...
  const resetSettings = async () => {
    ...
    try {
      ...
      await storage.update({ settings: defaultSettings });
      await onRefresh();
  ...
  const defaultPageOptions = [
    ...
    { value: 'links', label: 'Helpful Links' },
